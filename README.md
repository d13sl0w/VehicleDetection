...
Personally, I was more or less able to get past the slowness.  I see about 6-7 frames per second in my average-parameter processing, but I think that yields a bit more noise than a much slower one would, hence my lack of confidence in realy time. The HOG and LinearSVC made processing tolerable (although not at all if you were to want to use this for real time). But the jitteriness of my boxes still belay my troubles with false positives, I discuss a few larger/longer-term ideas for fixing this, but the best best in the short term would likely be continued focus on feature selection and on optimizing the filter/thresholding/averaging aspects of my heatmap function, also working with the classifier thresholds is a consideration, but a histogram of the scores showed very strongly opnionated classifications. Maybe probabilities though, though that is a considerable slowdown. 
